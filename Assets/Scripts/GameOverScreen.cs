...
public class GameOverScreen : MonoBehaviour
{
    ...
    public static string child_username; //Username of the child normally will be taken from Game Control.
    ...
    private void Start()
    {
        ...
        child_username = loginChildUsername.login_child_username;
